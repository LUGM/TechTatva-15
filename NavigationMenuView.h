...
@property (weak, nonatomic) IBOutlet UIButton *eventButtonPressed;
...
@property (weak, nonatomic) IBOutlet UIButton *onlineEventsButtonPressed;

@property (weak, nonatomic) IBOutlet UIImageView *sidebarImageView;
